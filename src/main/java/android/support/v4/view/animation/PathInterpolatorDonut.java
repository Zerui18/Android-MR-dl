...
class PathInterpolatorDonut implements Interpolator {
    ...
    public float getInterpolation(float t) {
        ...
        if (t >= TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER) {
    ...
    private static Path createQuad(float controlX, float controlY) {
        ...
        path.quadTo(controlX, controlY, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
        return path;
    }
    ...
    private static Path createCubic(float controlX1, float controlY1, float controlX2, float controlY2) {
        Path path = new Path();
        path.moveTo(0.0f, 0.0f);
        path.cubicTo(controlX1, controlY1, controlX2, controlY2, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
        return path;
    }
}
