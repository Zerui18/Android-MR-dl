...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(1, hasHeart ? TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(2, thumbIsUp ? TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == 2 && this.mRatingValue == TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER) {
            return true;
        }
        return false;
    }
