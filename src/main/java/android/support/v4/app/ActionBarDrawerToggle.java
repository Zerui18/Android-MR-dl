...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    private class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            if (isLayoutRTL && !this.mHasMirroring) {
                ...
                canvas.scale(PlayerStats.UNSET_VALUE, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
            }
            super.draw(canvas);
            canvas.restore();
        }
    ...
    public void syncState() {
        if (this.mDrawerLayout.isDrawerOpen((int) GravityCompat.START)) {
            this.mSlider.setPosition(TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
        } else {
