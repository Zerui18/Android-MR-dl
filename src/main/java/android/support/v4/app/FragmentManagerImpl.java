...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case 1:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, 0.0f, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
            case 2:
                return makeOpenCloseAnimation(this.mHost.getContext(), TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, 0.975f, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, 0.0f);
            case 3:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, 0.0f, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
            case 4:
                return makeOpenCloseAnimation(this.mHost.getContext(), TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, 1.075f, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, 0.0f);
            case 5:
                return makeFadeAnimation(this.mHost.getContext(), 0.0f, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
            case 6:
                return makeFadeAnimation(this.mHost.getContext(), TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, 0.0f);
            default:
