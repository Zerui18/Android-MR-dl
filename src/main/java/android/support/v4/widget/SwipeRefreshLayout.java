...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                SwipeRefreshLayout.this.mProgress.setArrowScale(TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER - interpolatedTime);
            }
        };
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                SwipeRefreshLayout.this.setAnimationProgress(TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER - interpolatedTime);
            }
        };
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float dragPercent = Math.min(TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, Math.abs(overscrollTop / this.mTotalDragDistance));
        ...
        if (!this.mScale) {
            ViewCompat.setScaleX(this.mCircleView, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
            ViewCompat.setScaleY(this.mCircleView, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER);
        }
        if (this.mScale) {
            setAnimationProgress(Math.min(TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, overscrollTop / this.mTotalDragDistance));
        }
        ...
        this.mProgress.setArrowScale(Math.min(TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, adjustedPercent));
