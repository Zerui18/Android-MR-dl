...
class DonutAnimatorCompatProvider implements AnimatorProvider {
    ...
    private static class DonutFloatValueAnimator implements ValueAnimatorCompat {
        ...
        private Runnable mLoopRunnable = new Runnable() {
            public void run() {
                float fraction = (((float) (DonutFloatValueAnimator.this.getTime() - DonutFloatValueAnimator.this.mStartTime)) * TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER) / ((float) DonutFloatValueAnimator.this.mDuration);
                if (fraction > TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER || DonutFloatValueAnimator.this.mTarget.getParent() == null) {
                    fraction = TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER;
                }
                DonutFloatValueAnimator.this.mFraction = fraction;
                DonutFloatValueAnimator.this.notifyUpdateListeners();
                if (DonutFloatValueAnimator.this.mFraction >= TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER) {
