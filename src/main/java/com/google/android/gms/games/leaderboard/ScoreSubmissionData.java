...
public final class ScoreSubmissionData {
    private static final String[] zzbcT = new String[]{"leaderboardId", "playerId", "timeSpan", "hasResult", "rawScore", "formattedScore", "newBest", "scoreTag"};
    private String zzaus;
    private int zzauz;
    private String zzbcV;
    private HashMap<Integer, Result> zzbdz = new HashMap();
