...
public interface zzamb extends IInterface {

    public static abstract class zza extends Binder implements zzamb {

        private static class zza implements zzamb {
        ...
        public static zzamb zzca(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzamb)) ? new zza(iBinder) : (zzamb) queryLocalInterface;
        }
