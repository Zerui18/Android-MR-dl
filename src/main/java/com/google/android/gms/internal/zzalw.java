...
public interface zzalw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzalw {

        private static class zza implements zzalw {
        ...
        public static zzalw zzbV(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.drive.realtime.internal.IErrorCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzalw)) ? new zza(iBinder) : (zzalw) queryLocalInterface;
        }
