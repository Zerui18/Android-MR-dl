...
public interface zzals extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzals {

        private static class zza implements zzals {
            ...
            public void zza(zzamf[] com_google_android_gms_internal_zzamfArr) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.realtime.internal.ICollaboratorsCallback");
                    obtain.writeTypedArray(com_google_android_gms_internal_zzamfArr, 0);
        ...
        public static zzals zzbR(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzals)) ? new zza(iBinder) : (zzals) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza((zzamf[]) parcel.createTypedArray(zzamf.CREATOR));
    ...
    void zza(zzamf[] com_google_android_gms_internal_zzamfArr) throws RemoteException;
}
