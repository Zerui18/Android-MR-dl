...
public interface zzamc extends IInterface {

    public static abstract class zza extends Binder implements zzamc {

        private static class zza implements zzamc {
        ...
        public static zzamc zzcb(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzamc)) ? new zza(iBinder) : (zzamc) queryLocalInterface;
        }
