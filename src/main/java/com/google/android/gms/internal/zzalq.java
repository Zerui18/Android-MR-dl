...
public interface zzalq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzalq {

        private static class zza implements zzalq {
        ...
        public static zzalq zzbP(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzalq)) ? new zza(iBinder) : (zzalq) queryLocalInterface;
        }
