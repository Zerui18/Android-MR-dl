...
public interface zzalz extends IInterface {

    public static abstract class zza extends Binder implements zzalz {

        private static class zza implements zzalz {
            ...
            public void zzfV(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.realtime.internal.IIntCallback");
        ...
        public static zzalz zzbY(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.drive.realtime.internal.IIntCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzalz)) ? new zza(iBinder) : (zzalz) queryLocalInterface;
        }
    ...
    void zzfV(int i) throws RemoteException;
}
