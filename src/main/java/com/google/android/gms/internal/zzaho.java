...
public class zzaho extends zzahr implements DriveFolder {
    ...
    private PendingResult<DriveFileResult> zza(GoogleApiClient googleApiClient, MetadataChangeSet metadataChangeSet, int i, zzk com_google_android_gms_drive_zzk) {
        ...
        final int i3 = i;
        final zzk com_google_android_gms_drive_zzk2 = com_google_android_gms_drive_zzk;
        return googleApiClient.zzb(new zzd(this, googleApiClient) {
            ...
            protected void zza(zzahk com_google_android_gms_internal_zzahk) throws RemoteException {
                metadataChangeSet2.zzzP().setContext(com_google_android_gms_internal_zzahk.getContext());
                com_google_android_gms_internal_zzahk.zzAi().zza(new zzagz(this.zzaLW.getDriveId(), metadataChangeSet2.zzzP(), i3, i2, com_google_android_gms_drive_zzk2), new zza(this));
            }
        });
    }
        ...
        if (metadataChangeSet == null) {
            ...
            return googleApiClient.zzb(new zzf(this, googleApiClient) {
                ...
                protected void zza(zzahk com_google_android_gms_internal_zzahk) throws RemoteException {
                    ...
                    com_google_android_gms_internal_zzahk.zzAi().zza(new zzahb(this.zzaLW.getDriveId(), metadataChangeSet.zzzP()), new zzb(this));
                }
            });
        } else {
