...
public class AdvertisingIdClient {
    ...
    static zzcn zza(Context context, com.google.android.gms.common.zza com_google_android_gms_common_zza) throws IOException {
        try {
            return com.google.android.gms.internal.zzcn.zza.zzf(com_google_android_gms_common_zza.zza(TapjoyConstants.TIMER_INCREMENT, TimeUnit.MILLISECONDS));
        } catch (InterruptedException e) {
    ...
    Uri zza(Info info, boolean z, Throwable th) {
        ...
        if (th != null) {
            bundle.putString(String.VIDEO_ERROR, th.getClass().getName());
        }
