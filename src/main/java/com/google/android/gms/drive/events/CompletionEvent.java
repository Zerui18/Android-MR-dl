...
public final class CompletionEvent extends zza implements ResourceEvent {
    ...
    private void zzy(boolean z) {
        ...
        try {
            ...
            valueOf = z ? "snooze" : TapjoyConstants.TJC_FULLSCREEN_AD_DISMISS_URL;
    ...
    public String toString() {
        ...
        return String.format(Locale.US, "CompletionEvent [id=%s, status=%s, trackingTag=%s]", new Object[]{this.zzaJj, Integer.valueOf(this.zzJh), str});
    }
