...
public class Query extends zza {
    ...
    public static class Builder {
        ...
        private final List<Filter> zzaOG = new ArrayList();
        ...
        public Query build() {
            return new Query(new zzr(zzx.zzaPi, this.zzaOG), this.zzaOC, this.zzaOD, this.zzaOE, this.zzaOF, this.zzaKl, this.zzaMr);
        }
