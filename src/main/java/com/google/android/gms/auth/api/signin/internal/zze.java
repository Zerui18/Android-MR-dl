...
public final class zze {
    ...
    class AnonymousClass1 extends zza<GoogleSignInResult> {
        ...
        AnonymousClass1(GoogleApiClient googleApiClient, zzl com_google_android_gms_auth_api_signin_internal_zzl, GoogleSignInOptions googleSignInOptions) {
        ...
        protected void zza(zzd com_google_android_gms_auth_api_signin_internal_zzd) throws RemoteException {
            ((zzi) com_google_android_gms_auth_api_signin_internal_zzd.zzwW()).zza(new zza(this) {
                final /* synthetic */ AnonymousClass1 zzajv;
    ...
    class AnonymousClass2 extends zza<Status> {
        ...
        protected void zza(zzd com_google_android_gms_auth_api_signin_internal_zzd) throws RemoteException {
            ((zzi) com_google_android_gms_auth_api_signin_internal_zzd.zzwW()).zzb(new zza(this) {
                final /* synthetic */ AnonymousClass2 zzajw;
    ...
    private static OptionalPendingResult<GoogleSignInResult> zza(GoogleApiClient googleApiClient, zzl com_google_android_gms_auth_api_signin_internal_zzl, GoogleSignInOptions googleSignInOptions) {
        ...
        return new zzabc(googleApiClient.zza(new AnonymousClass1(googleApiClient, com_google_android_gms_auth_api_signin_internal_zzl, googleSignInOptions)));
    }
