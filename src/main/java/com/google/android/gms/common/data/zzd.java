...
public class zzd<T extends SafeParcelable> extends AbstractDataBuffer<T> {
    private static final String[] zzaCo = new String[]{String.DATA};
    ...
    public static <T extends SafeParcelable> void zza(zza com_google_android_gms_common_data_DataHolder_zza, T t) {
        ...
        contentValues.put(String.DATA, obtain.marshall());
    ...
    public T zzcB(int i) {
        byte[] zzg = this.zzazI.zzg(String.DATA, i, this.zzazI.zzcC(i));
        Parcel obtain = Parcel.obtain();
