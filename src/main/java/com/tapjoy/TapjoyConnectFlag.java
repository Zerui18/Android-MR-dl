...
public class TapjoyConnectFlag {
    ...
    public static final String[] FLAG_ARRAY = new String[]{USER_ID, ENABLE_LOGGING, SERVICE_URL, PLACEMENT_URL, STORE_NAME, DEBUG_DEVICE_ID};
    public static final String MEDIATION_CONFIGS = "TJC_OPTION_MEDIATION_CONFIGS";
    public static final String MEDIATION_TIMEOUT = "TJC_OPTION_MEDIATION_TIMEOUT";
