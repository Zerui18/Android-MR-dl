...
public final class TapjoyConnectUnity {
    ...
    private static final TJConnectListener CONNECT_LISTENER = new TJConnectListener() {
    ...
    private static final TJEarnedCurrencyListener EARNED_CURRENCY_LISTENER = new TJEarnedCurrencyListener() {
    ...
    private static final TJPlacementListener PLACEMENT_LISTENER = new TJPlacementListener() {
        public void onRequestSuccess(TJPlacement tJPlacement) {
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementCallback", "OnPlacementRequestSuccess," + ((String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID())) + "," + tJPlacement.isContentAvailable());
        }

        public void onRequestFailure(TJPlacement tJPlacement, TJError tJError) {
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementCallback", "OnPlacementRequestFailure," + ((String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID())) + "," + tJError.message);
        }

        public void onContentReady(TJPlacement tJPlacement) {
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementCallback", "OnPlacementContentReady," + ((String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID())));
        }

        public void onContentShow(TJPlacement tJPlacement) {
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementCallback", "OnPlacementContentShow," + ((String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID())));
        }

        public void onContentDismiss(TJPlacement tJPlacement) {
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementCallback", "OnPlacementContentDismiss," + ((String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID())));
        }
        ...
        public void onPurchaseRequest(TJPlacement tJPlacement, TJActionRequest tJActionRequest, String str) {
            ...
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementCallback", "OnPurchaseRequest," + str2 + "," + tJActionRequest.getRequestId() + "," + tJActionRequest.getToken() + "," + str);
        }

        public void onRewardRequest(TJPlacement tJPlacement, TJActionRequest tJActionRequest, String str, int i) {
            String str2 = (String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID());
            TapjoyConnectUnity.actionRequestMap.put(str2, tJActionRequest);
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementCallback", "OnRewardRequest," + str2 + "," + tJActionRequest.getRequestId() + "," + tJActionRequest.getToken() + "," + str + "," + i);
        }
    };
    private static final TJPlacementVideoListener PLACEMENT_VIDEO_LISTENER = new TJPlacementVideoListener() {
        public void onVideoStart(TJPlacement tJPlacement) {
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementVideoCallback", "OnVideoStart," + ((String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID())));
        }

        public void onVideoError(TJPlacement tJPlacement, String str) {
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementVideoCallback", "OnVideoError," + ((String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID())) + "," + str);
        }

        public void onVideoComplete(TJPlacement tJPlacement) {
            UnityPlayer.UnitySendMessage(TapjoyConnectUnity.UNITY_GAME_OBJECT_NAME, "OnNativePlacementVideoCallback", "OnVideoComplete," + ((String) TapjoyConnectUnity.javaToCSharpMap.get(tJPlacement.getGUID())));
        }
    };
    ...
    private static final TJVideoListener VIDEO_LISTENER = new TJVideoListener() {
    ...
    static final Runnable showDefaultEarnedCurrencyAlert = new Runnable() {
        public void run() {
            try {
                new Builder(TapjoyConnectUnity.activity).setTitle("Congratulations!").setMessage("You've just earned " + TapjoyConnectUnity.earnedAmount + " " + TapjoyConnectUnity.earnedCurrencyName).setPositiveButton("OK", new OnClickListener() {
    ...
    public static void onActivityStart() {
        if (VERSION.SDK_INT < 14 && activity != null) {
            activity.runOnUiThread(new Runnable() {
                public void run() {
    ...
    public static Hashtable<String, Object> getReferenceDictionary(String str, boolean z) {
        ...
        cSharpDictionaryRefs.put(str, hashtable);
        return hashtable;
    }
    ...
    public static void setDictionaryInDictionary(String str, String str2, String str3) {
        ...
        if (hashtable2 == null) {
            ...
            cSharpDictionaryRefs.put(str3, hashtable2);
            hashtable = hashtable2;
        } else {
            hashtable = hashtable2;
        }
        hashtable2 = (Hashtable) cSharpDictionaryRefs.get(str2);
        if (hashtable2 == null) {
