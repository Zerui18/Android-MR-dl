...
public class GoogleIABProxyActivity extends Activity {
    ...
    private Boolean _created = Boolean.valueOf(false);
    private Boolean _didCompletePurcaseFlow = Boolean.valueOf(false);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (!GoogleIABPluginBase.instance().helper.launchPurchaseFlow(this, sku, itemType, null, 10001, GoogleIABPluginBase.instance(), developerPayload)) {
                finish();
            }
        } catch (Exception e) {
            ...
            if (GoogleIABPluginBase.instance().helper == null) {
                ...
                GoogleIABPluginBase.instance().helper.handleActivityResult(10001, 0, null);
            }
            finish();
        }
    }
