    ...
    protected static Constructor getConstructorID(Class cls, String str) {
        ...
        if (a(aVar)) {
            ...
            while (i < length) {
                ...
                if (a2 > f) {
                    if (a2 == TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER) {
                        break;
                    }
                    member3 = member2;
                } else {
    ...
    protected static Field getFieldID(Class cls, String str, String str2, boolean z) {
        ...
        if (a(aVar)) {
            ...
            while (cls != null) {
                ...
                field = field2;
                if (f == TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER || cls.isPrimitive() || cls.isInterface() || cls.equals(Object.class) || cls.equals(Void.TYPE)) {
                    break;
                }
