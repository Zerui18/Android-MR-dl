...
public final class j extends Dialog implements TextWatcher, OnClickListener {
    ...
    public j(Context context, UnityPlayer unityPlayer, String str, int i, boolean z, boolean z2, boolean z3, String str2) {
        super(context);
        this.a = context;
        this.b = unityPlayer;
    ...
    protected final View createSoftInputView() {
        ...
        anonymousClass2.setText(this.a.getResources().getIdentifier("ok", "string", TapjoyConstants.TJC_DEVICE_PLATFORM_TYPE));
